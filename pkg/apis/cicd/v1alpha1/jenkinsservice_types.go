...
import (
	...
	v1 "github.com/cicd-apiserver-builder/pkg/apis/cicd/v1"
...
type JenkinsServiceStatus struct {
	...
	Instances      []v1.JenkinsServiceInstance `json:"instances"`
}
...
func (in *JenkinsService) ConvertToStorageVersion(storageObj runtime.Object) error {
	storageObj.(*v1.JenkinsService).ObjectMeta = in.ObjectMeta
	storageObj.(*v1.JenkinsService).TypeMeta = in.TypeMeta
	storageObj.(*v1.JenkinsService).Spec.InstanceAmount = in.Spec.InstanceAmount
	storageObj.(*v1.JenkinsService).Spec.InstanceCpu = in.Spec.InstanceCpu
	return nil
}
...
func (in *JenkinsService) ConvertFromStorageVersion(storageObj runtime.Object) error {
	in.TypeMeta = storageObj.(*v1.JenkinsService).TypeMeta
	in.ObjectMeta = storageObj.(*v1.JenkinsService).ObjectMeta
	in.Status.ApprovalStatus = storageObj.(*v1.JenkinsService).Status.ApprovalStatus
	in.Status.Instances = storageObj.(*v1.JenkinsService).Status.Instances
	in.Spec.InstanceAmount = storageObj.(*v1.JenkinsService).Spec.InstanceAmount
	in.Spec.InstanceCpu = storageObj.(*v1.JenkinsService).Spec.InstanceCpu
	return nil
}
